...
```{r regression}
mod_exp1 <- 
  glm(chose_which_uncontaminated ~ goal_condition*base_rate, data = dat_exp1_coded, family = "binomial")
...
```{r}
mod_exp2 <- 
  glm(chose_which_uncontaminated ~ goal_condition*decision_structure, data = dat_exp2, family = "binomial")
